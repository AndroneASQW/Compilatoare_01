...
{
       0,   159,   159,   160,   164,   200,   207,   208,   211,   218,
     221,   229,   234,   237,   243,   246,   252,   258
};
#endif
...
{
  "$end", "error", "$undefined", "'+'", "'-'", "'*'", "INT", "RETURN",
  "IDENTIFIER", "VAR_NB", "'('", "')'", "'{'", "'}'", "','", "';'",
  "$accept", "source", "function", "F_NAME", "ARGUMENTS", "ARGUMENT",
  "BODY", "exp", "result", "value", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,    43,    45,    42,   258,   259,   260,   261,
      40,    41,   123,   125,    44,    59
};
# endif
...
{
     -19,     5,   -19,    -2,   -19,     3,   -19,    11,    10,    -7,
     -19,   -19,     7,    11,    13,   -19,     6,     8,   -19,   -19,
       6,    -3,    17,   -19,   -19,    -1,     6,     6,   -19,     6,
     -19,    17,    17,   -19
};
...
{
       2,     0,     1,     0,     3,     0,     5,     0,     0,     0,
       6,     8,     0,     0,     0,     7,     0,     0,    15,    16,
       0,     0,    12,    14,     4,     0,     0,     0,     9,     0,
      17,    10,    11,    13
};
...
{
     -19,   -19,   -19,   -19,   -19,    12,   -19,     4,   -18,    -6
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     4,     5,     9,    10,    17,    21,    22,    23
};
...
{
      26,    27,    26,    27,    12,     2,     6,    13,    31,    32,
      30,     3,    28,     7,    18,    19,    20,     8,    11,    14,
      16,    24,    29,    33,    25,    15
};

static const yytype_int8 yycheck[] =
{
       3,     4,     3,     4,    11,     0,     8,    14,    26,    27,
      11,     6,    15,    10,     8,     9,    10,     6,     8,    12,
       7,    13,     5,    29,    20,    13
};
...
{
       0,    17,     0,     6,    18,    19,     8,    10,     6,    20,
      21,     8,    11,    14,    12,    21,     7,    22,     8,     9,
      10,    23,    24,    25,    13,    23,     3,     4,    15,     5,
      11,    24,    24,    25
};
...
#line 201 "compiler.y"
        {
		sprintf(functions_table[functions_nb],"%s",(yyvsp[0].name));
		sprintf(function_identifier[functions_nb++],"_%s",(yyvsp[0].name));  //check here
	}
...
#line 212 "compiler.y"
        {
		arguments_identifier[arguments_nb++] = (yyvsp[0].name);
		reg_nb = arguments_nb;
	}
...
#line 247 "compiler.y"
		...
		for(int i=0;i < arguments_nb;i++)
		   if(strcmp((yyvsp[0].name), arguments_identifier[i])==0)
		   	(yyval.nb) = i;
	}
